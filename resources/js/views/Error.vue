<template>
  <div id="misc">
    <img
      class="misc-mask"
      height="226"
      :src="`${window.location.origin}/assets/images/misc/misc-mask-${$vuetify.theme.dark ? 'dark' : 'light'}.png`"
    />

    <v-img
      class="misc-tree"
      :src="`${window.location.origin}/assets/images/misc/tree-4.png`"
    ></v-img>
    ...
    <div class="page-title text-center px-5">
      ...
      <div class="misc-character d-flex justify-center">
        <v-img
          max-width="700"
          :src="`${window.location.origin}/assets/images/3d-characters/error.png`"
        ></v-img>
      </div>
