...
export default {
  setup() {
    const totalEarning = [
      {
        avatar: `${window.location.origin}/assets/images/logos/zipcar.png`,
        title: 'Zipcar',
      ...
      {
        avatar: `${window.location.origin}/assets/images/logos/bitbank.png`,
        title: 'Bitbank',
      ...
      {
        avatar: `${window.location.origin}/assets/images/logos/aviato.png`,
        title: 'Aviato',
